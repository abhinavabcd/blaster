...
'''
import random
from blaster.gevent_aws_base.base import start_stream_server, route_handler,\
    process_post_params, process_post_data
...
##FOR handling you post arguments as key value data
